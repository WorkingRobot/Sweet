...
with open("theme.gresource.xml", "w") as gres:
    ...
    gres.write('<gresource prefix="/me/workingrobot/l4/themes/sweet-ambar/">')
...
os.system(f"glib-compile-resources --sourcedir . --target Sweet-Ambar.gresource theme.gresource.xml")